...
class _CurrentRecipeViewState extends State<CurrentRecipeView> {
  ...
  void initState() {
    super.initState();
    // mark this recipe as active so MainScaffold can re-open it when user taps "Danas"
    appState.activeRecipe.value = {'id': widget.recipeId, 'title': widget.title};
    _loadSteps();
  }
                  ...
                  Expanded(
                    child: OutlinedButton(
                      onPressed: () async {
                        ...
                        await _saveSteps();
                        // Clear active recipe and return to main
                        appState.activeRecipe.value = null;
                        if (context.mounted) {
