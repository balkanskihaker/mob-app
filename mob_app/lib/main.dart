  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          // If Danas tab and active recipe exists, show recipe view
          if (index == 0 && appState.activeRecipe.value != null) {
        ...
        children: [
          ...
          Builder(
            builder: (ctx) {
              ...
              final int cacheWidth = (mq.size.width * mq.devicePixelRatio / 1.5)
                  .toInt();
              return Image(
                image: ResizeImage(
